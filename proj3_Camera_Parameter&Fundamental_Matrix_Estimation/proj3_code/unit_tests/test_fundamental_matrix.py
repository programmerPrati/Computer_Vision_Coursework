...
import least_squares_fundamental_matrix
import two_view_data
from fundamental_matrix import (create_F, 
                                point_line_distance,
...
class TestFundamentalMatrix3(unittest.TestCase):
    ...
    def test_signed_point_line_errors(self):
        ...
        -0.010741942311713276, -0.11090839708093228, 0.807599747032202, \
        -0.6389290605415935, 0.43120125206729076, -0.1933130214659827, 0.5364473985265974, \
        -0.06504531631269597, -0.07293979927334383, -0.7116760338393701, -0.020252886494253417, \
        -0.20680017454784194, 1.4532660370005839, -1.066478221124915, 0.5592197543231424, -0.24913836810752046, \
        0.8910954125866279, -0.10857002381985015, -0.1399824597173412, -1.175722053758061
